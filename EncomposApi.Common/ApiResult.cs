...
namespace EncomposApi
{
    ...
    public class ApiResult
    {
        ...
        public static ApiResult Ok(string message = null) => new ApiResult(200, message);
        
        public static ApiResult Created(string message = null) => new ApiResult(201, message);
        
        public static ApiResult Accepted(string message = null) => new ApiResult(202, message);
